/*
  # Add diverse service plans for each category

  This migration adds realistic, varied plans for different service categories
  with different pricing tiers and features.
*/

-- Web Development Services - Diverse Plans
UPDATE services SET 
  plans = '[
    {
      "name": "Basic Website",
...
-- Video Editing Services - Diverse Plans
UPDATE services SET 
  plans = '[
    {
      "name": "Basic Editing",
...
-- Copywriting Services - Diverse Plans
UPDATE services SET 
  plans = '[
    {
      "name": "Basic Copy",
...
-- Social Media Services - Diverse Plans
UPDATE services SET 
  plans = '[
    {
...
-- App Development Services - Diverse Plans
UPDATE services SET 
  plans = '[
    {
      "name": "Basic App",
...
-- Graphic Design Services - Diverse Plans
UPDATE services SET 
  plans = '[
    {
      "name": "Basic Graphics",
...
-- UI/UX Design Services - Diverse Plans
UPDATE services SET 
  plans = '[
    {
      "name": "Basic Design",
...
-- Audio/Music Services - Diverse Plans
UPDATE services SET 
  plans = '[
    {
      "name": "Basic Audio",
...
-- Business Consulting Services - Diverse Plans
UPDATE services SET 
  plans = '[
    {
...
-- Content Writing Services - Diverse Plans
UPDATE services SET 
  plans = '[
    {
      "name": "Basic Content",
...
-- Video Production Services - Diverse Plans
UPDATE services SET 
  plans = '[
    {
